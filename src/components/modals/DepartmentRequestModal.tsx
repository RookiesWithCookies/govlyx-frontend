                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="input input-bordered w-full rounded-xl bg-base-200 border-none focus:ring-2 focus:ring-blue-600/50 font-bold"
                      value={form.deptName}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      className="textarea textarea-bordered w-full rounded-xl bg-base-200 border-none focus:ring-2 focus:ring-blue-600/50 font-bold"
                      value={form.reason}
                  ...
                  <button
                    disabled={submitting}
                    className="btn w-full bg-blue-600 hover:bg-blue-700 text-white border-none rounded-xl h-12 font-black shadow-lg shadow-blue-600/20 disabled:bg-base-300 mt-4"
                  >
