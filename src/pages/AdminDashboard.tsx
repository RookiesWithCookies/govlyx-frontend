...
const AdminDashboard = () => {
  ...
  // Mock Data
  const stats = [
    { label: "Total Citizens", value: "24,512", icon: Users, color: "text-blue-500", bg: "bg-blue-500/10" },
      ...
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div className="space-y-1.5">
          ...
          <h1 className="text-4xl font-black tracking-tight flex items-center gap-3">
            Super Admin Console
            <BadgeCheck className="text-blue-500 mt-1" size={28} />
          </h1>
        ...
        <div className="col-span-12 xl:col-span-4 space-y-6">
          ...
          <div className="rounded-3xl border border-base-300 bg-base-200/50 p-6 space-y-6">
            <div className="space-y-4">
              {[
                { type: "post", text: "New post in Community: Delhi NCR", time: "Just now", color: "text-blue-500" },
                ...
                <div key={i} className="flex gap-4 items-start group">
                  ...
                  <div>
                    <p className="text-sm font-black group-hover:text-blue-500 transition-colors uppercase tracking-tight">{log.text}</p>
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    className="btn flex-1 bg-blue-600 hover:bg-blue-700 text-white border-none rounded-2xl font-black h-14 shadow-lg shadow-blue-600/20"
                  >
                    Generate & Notify
                  </button>
                </div>
